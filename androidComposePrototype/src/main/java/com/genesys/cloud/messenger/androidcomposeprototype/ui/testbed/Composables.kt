...
fun TestBedContent(
    ...
    Column(
        ...
        Text(
            "Commands: oktaSignIn, oktaSignInWithPKCE, connect, connectAuthenticated, send <msg>, history, clearConversation, attach, detach, delete <attachmentId> , deployment, bye, healthCheck, addAttribute <key> <value>, typing, fetchAuthJwt",
