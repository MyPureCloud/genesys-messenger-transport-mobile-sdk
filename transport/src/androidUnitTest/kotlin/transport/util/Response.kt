...
internal object Response {
    ...
    fun onMessage(direction: Message.Direction = Message.Direction.Inbound) = """{"type":"message","class":"StructuredMessage","code":200,"body":{"text":"Hello world!","direction":"${direction.name}","id":"test_id","channel":{"time":"2022-08-22T19:24:26.704Z","messageId":"message_id"},"type":"Text","tracingId":"${TestValues.TRACING_ID}"}}"""
    ...
    const val healthCheckResponse =
        """{"type":"response","class":"StructuredMessage","code":200,"body":{"text":"ping","type":"Text","direction":"Inbound","id":"SGVhbHRoQ2hlY2tNZXNzYWdlSWQ=","tracingId":"SGVhbHRoQ2hlY2tNZXNzYWdlSWQ="}}"""
