...
private fun HttpRequestBuilder.headerAuthorizationBearer(jwt: String) = header(HttpHeaders.Authorization, "bearer $jwt")

private fun HttpRequestBuilder.headerOrigin(origin: String) = header(HttpHeaders.Origin, origin)
